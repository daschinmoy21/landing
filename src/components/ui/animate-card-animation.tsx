	...
	return (
		...
		>
			...
			<div className="bench-card-titlebar">
				...
				<div className="bench-card-title" style={{ textTransform: 'uppercase' }}>
					benchmark · {readableAppName}
				</div>
			</div>
			...
			<div className="bench-card-body" style={{ padding: '18px 24px 22px' }}>
				...
				<div className="sub" style={{ marginBottom: '16px', fontSize: '11px' }}>
					Russel vs Podman
				</div>
							...
							<div className="bar-row" key={idx} style={{ marginBottom: '14px' }}>
								<div
									style={{
										fontFamily: 'var(--font-mono)',
										fontSize: '12px',
										color: row.winner ? 'var(--text-color)' : 'var(--text-muted)',
										marginBottom: '4px',
										fontWeight: 600
									}}
								>
								...
								<div className="bar-track" style={{ position: 'relative', height: '22px', borderRadius: '6px', overflow: 'hidden' }}>
									<div
									...
									>
										<span
											style={{
												...
												fontSize: '11px',
												fontWeight: 700,
												color: row.winner ? '#040803' : '#ffffff',
												whiteSpace: 'nowrap'
											}}
										>
											{row.val}
...
function AnimatedCard({
	...
	return (
		<motion.div
			...
			className="border-border absolute flex h-[360px] flex-col overflow-hidden rounded-xl border shadow-2xl will-change-transform"
			style={{
				zIndex,
				left: '50%',
